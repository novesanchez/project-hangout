...
<!--                                <a href="#" title="HangOut Request"><img src="/images/my_hangout_icon_4.png" /></a> &nbsp;
                            ...
                            <li> Friends&nbsp;
                                 ...
                                 <div  style="margin-left: 15px;font-size: 11px;">
                                    <ul>
                                        <li style='font-weight:bold;'><a href="#">Friend Request</a></li>                                        
                                    </ul>
                                </div>
                            </li>
                        </ul>
	...
	<div id="post-content-wrap" class="grid_7">
           <h3 class="blog-page-title"><a href="#">Friend Request</a> </h3>
           <div class="friend_req"> 
            <div id="tab1" class="tab_content"> 
                ...
                <a href="#" id="GetFriendRequests" style="width:100%;float:left;font-size:12px;"> [ Refresh ] </a> <br/>                
