...
<!--                                <a href="#" title="HangOut Request"><img src="/images/my_hangout_icon_4.png" /></a> &nbsp;
                                ...
                                <div  style="margin-left: 15px;font-size: 11px;">
                                    <ul>
                                        <li style='font-weight:bold;'><a href="/index.php/home/rateHangout">Rate HangOut</a></li>
                                        <li><a href="/index.php/home/hangoutReview">HangOut Reviews</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li> Friends &nbsp;
	...
	<div id="post-content-wrap" class="grid_7">
		 ...
		 <div class="blog-page-post">
			<h3 class="blog-page-title"><a href="#">Select the HangOut you want to Rate</a> </h3>
			...
			<div class="blog-excerpt" id="myRates"></div> 
                         [ <a href="#" id="myRateToHangout" > Refresh </a> ]                        
